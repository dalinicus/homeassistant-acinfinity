...
This integration requires the controller to be connected to wifi, as it utilizes the UIS cloud to sync data. Bluetooth only devices such as Controller 67, or UIS controllers running bluetooth only mode, are not compatable with this integration as they do not sync data to the UIS Cloud
