...
class TestSensors:
    ...
    async def test_async_setup_entry_ai_controller_f_temperature_created(self, setup):
        ...
        test_objects.ac_infinity.data.sensor_properties.pop(
            (
                str(AI_DEVICE_ID),
                CONTROLLER_ACCESS_PORT,
    ...
    async def test_async_setup_entry_ai_hydro_ec_ms_created(self, setup):
        ...
        test_objects: ACTestObjects = setup
        test_objects.ac_infinity.data.sensor_properties = copy.deepcopy(test_objects.ac_infinity.data.sensor_properties)
        test_objects.ac_infinity.data.sensor_properties.pop(
