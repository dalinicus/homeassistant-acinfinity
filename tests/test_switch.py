...
class TestSwitches:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (DeviceControlKey.AUTO_TARGET_TEMP_ENABLED, 1, True),
            (DeviceControlKey.AUTO_TARGET_HUMIDITY_ENABLED, 1, True),
            (DeviceControlKey.VPD_HIGH_ENABLED, 1, True),
            (DeviceControlKey.VPD_LOW_ENABLED, 1, True),
            (DeviceControlKey.VPD_TARGET_ENABLED, 1, True),
            ...
            (DeviceControlKey.AUTO_TARGET_TEMP_ENABLED, 0, False),
            (DeviceControlKey.AUTO_TARGET_HUMIDITY_ENABLED, 0, False),
            (DeviceControlKey.VPD_HIGH_ENABLED, 0, False),
            (DeviceControlKey.VPD_LOW_ENABLED, 0, False),
            (DeviceControlKey.VPD_TARGET_ENABLED, 0, False),
            ...
            (DeviceControlKey.AUTO_TARGET_TEMP_ENABLED, None, False),
            (DeviceControlKey.AUTO_TARGET_HUMIDITY_ENABLED, None, False),
            (DeviceControlKey.VPD_HIGH_ENABLED, None, False),
            (DeviceControlKey.VPD_LOW_ENABLED, None, False),
            (DeviceControlKey.VPD_TARGET_ENABLED, None, False),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (DeviceControlKey.AUTO_TARGET_TEMP_ENABLED, 1),
            (DeviceControlKey.AUTO_TARGET_HUMIDITY_ENABLED, 1),
            (DeviceControlKey.VPD_HIGH_ENABLED, 1),
            (DeviceControlKey.VPD_LOW_ENABLED, 1),
            (DeviceControlKey.VPD_TARGET_ENABLED, 1),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (DeviceControlKey.AUTO_TARGET_TEMP_ENABLED, 0),
            (DeviceControlKey.AUTO_TARGET_HUMIDITY_ENABLED, 0),
            (DeviceControlKey.VPD_HIGH_ENABLED, 0),
            (DeviceControlKey.VPD_LOW_ENABLED, 0),
            (DeviceControlKey.VPD_TARGET_ENABLED, 0),
